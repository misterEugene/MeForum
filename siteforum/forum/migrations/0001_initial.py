# Generated by Django 4.2.3 on 2023-08-02 05:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='forum.categories', verbose_name='категория')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='comments_written', to=settings.AUTH_USER_MODEL, verbose_name='автор')),
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='comments_post', to='forum.posts', verbose_name='пост')),
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='comments_received', to=settings.AUTH_USER_MODEL, verbose_name='адресат')),
            ],
            options={
